	...
	?>
		<h2>Form Edit Member</h2>
			...
			<form action="" method="POST">
				...
				<tr><td>Password Member</td><td> <input type="text" name="password_member" value="<?php echo $d['password_member'] ?>"></td></tr>
	...
	<?php
		...
		?>
			...
			<form action="" method="POST">
				...
				<tr><td>Password Member</td><td> <input type="text" name="username_member"></td></tr>
